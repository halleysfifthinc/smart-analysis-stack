...
% No need to get the .mot angle indices again, compatible trials will use the
...
switch angleStr
  ...
  case 'arm_rot_r'
    angles_raw = data(:,handles.arm_rot_r_ind);
  case 'elbow_flex_r'
  ...
  case 'arm_rot_l'
    angles_raw = data(:,handles.arm_rot_l_ind);
  case 'elbow_flex_l'
